...
function App() {
  const [movies, setmovies] = useState([
    ...
    },
    {
      name: "The Circle",
      posterurl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8FOCykdpEWQhbxhFgEN-kByVepA3l55UWFQ&s",
      description:
    ...
    },
    {
      name: "Paper Lives",
      posterurl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjTeHnrlgluo-xV8cOeN_b8xHCHITMxo-2Pw&s",
      description:
  ...
  return (
    <div className="App">
      <Navbarr/>
       ...
       <BgVedio/>
      <Routes>
        <Route path="/" element={ <MoviesCardList  movies={movies} setmovies={setmovies}  /> } />
